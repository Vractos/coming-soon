  ...
  return (
    <Layout>
      ...
      <div className='md:h-2/3 flex flex-col md:justify-center px-8 md:pl-20 md:pr-0 text-center md:text-left'>
        ...
        <p className="text-[1.2rem] leading-[1.75rem] md:text-[#525252] text-[#F2F3F3] font-medium">Em breve uma nova maneira de gestão para<br className='hidden md:visible'/> sua loja</p>
        <Input/>
      </div>
    </Layout>
  )
