  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.atrati.com/"/>
    ...
    {`
      ...
      <Layout>
        ...
        <div className='md:h-2/3 flex flex-col md:justify-center px-8 md:pl-20 md:pr-0 text-center md:text-left md:bg-transparent bg-[#5E17EB]'>
